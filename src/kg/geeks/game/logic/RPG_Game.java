...
public class RPG_Game {
    ...
    public static void startGame() {
        ...
        Magic magic = new Magic(260, 20, 5,"Amanjan");
        Berserk berserk = new Berserk(260, 10, "Ainazik");
        Medic assistant = new Medic(300, 5, 5, "Nurdin");
        Thor thor = new Thor(300, 15, "Thor");
        Hacker hack = new Hacker(300, 15, "Evgeniy");
        Witcher witcher = new Witcher(400, 0, "Hakim");
        Hero[] heroes = {warrior1, warrior2, doc, magic, berserk, assistant, witcher, hack, thor};
